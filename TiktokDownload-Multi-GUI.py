...
class TikTok():
    ...
    def out_Print(self):
        print(r'''
 _____ _ _    _        _    ____                      _                 _        __  __       _ _   _        ____ _   _ ___
|_   _(_) | _| |_ ___ | | _|  _ \  _____      ___ __ | | ___   __ _  __| |      |  \/  |_   _| | |_(_)      / ___| | | |_ _|
  | | | | |/ / __/ _ \| |/ / | | |/ _ \ \ /\ / / '_ \| |/ _ \ / _` |/ _` | _____| |\/| | | | | | __| |_____| |  _| | | || |
  | | | |   <| || (_) |   <| |_| | (_) \ V  V /| | | | | (_) | (_| | (_| ||_____| |  | | |_| | | |_| |_____| |_| | |_| || |
  |_| |_|_|\_\\__\___/|_|\_\____/ \___/ \_/\_/ |_| |_|_|\___/ \__,_|\__,_|      |_|  |_|\__,_|_|\__|_|      \____|\___/|___|''')
...
if __name__ == "__main__":
    ...
    def get_args(user,dir,music,count,mode):
        ...
        layout = [ 
            ...
            [sg.Text('单页下载的数量,默认35无需修改')],
            [sg.Input("35")],
            [sg.OK()]
        ]
        event,value = sg.Window('TiktokDownload-Multi-GUI  --  By aoligei-max').Layout(layout).Read()
        if value[1] == True:
            musicdlpass = "yes"
        else:
            musicdlpass = "no"
        if value[2] == "" :
            ...
            countera = int(value[2])
        TK.setting(value[0],musicdlpass,countera,"./Download","post")
